      ...
      <div>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              type="submit"
              className="mt-3 w-full py-4 px-6 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-neutral-950 font-bold text-sm transition-all duration-200 shadow-md cursor-pointer"
            >
              Send Message →
            </button>
          </form>
